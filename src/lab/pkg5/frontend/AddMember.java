...
public class AddMember extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty()) {
            //Add warning message if text field is empty with a specific image
            ...
            //Make sure trainer is registered  
            TrainerRole trainer = new TrainerRole();
            boolean registered = trainer.addMember(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), jTextField5.getText(), jTextField6.getText());
            if (!registered) {
                //If the trainer is not registered add a warning message
                ImageIcon image = new ImageIcon("warning.png");
                JOptionPane.showMessageDialog(this, "The member with ID " + jTextField1.getText() + " already exists.", "Message", JOptionPane.PLAIN_MESSAGE, image);
            } else {
                //If the trainer is registered display a message stating that
                JOptionPane.showMessageDialog(this, "The member with ID " + jTextField1.getText() + " has been successfully added.", "Message", JOptionPane.PLAIN_MESSAGE);
                trainer.logout();
                this.dispose();
            }
        }
